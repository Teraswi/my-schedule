...
('1) 8.00 - 8.45', 'БЖ(Кол)-БЖ(Фад)', 'Практика(Викт)', 'Станд.(Карп)', 'Станд.(Карп)', '-', '-/Ин.яз(Горд)'),
('2) 8.55 - 9.40', 'БЖ(Кол)-БЖ(Фад)', 'Практика(Викт)', 'ИС(Сог)', 'Станд.(Карп)', '-', '-/Ин.яз(Горд)'),
('3) 9.50 - 10.35', 'ДМ(Карп)', 'ИС(Сог)', 'ИС(Сог)', 'Физра', 'ИС(Сог)', 'МДК 08.01(Викт)'),
('4) 10.45 - 11.30', 'ДМ(Карп)', 'ИС(Сог)', 'ДМ(Карп)', 'Физра', 'ИС(Сог)', 'МДК 08.01(Викт)'),
('Обед', '-', '-', '-', '-', '-', '-'),
('5) 12.15 - 13.00', 'Ин-яз(Анис)/-', 'ЧМ(Карп)', 'УП по ПМ 05', 'МДК 08.01(Викт)', 'УП по ПМ 05', 'Практика(Викт)'),
('6) 13.10 - 13.55', 'Ин-яз(Анис)/-', 'ЧМ(Карп)', 'УП по ПМ 05', 'МДК 08.01(Викт)', 'УП по ПМ 05', '-'),
('7) 14.05 - 14.50', '-', 'УП по ПМ 05', 'Кл. час', 'ЧМ(Карп)', 'УП по ПМ 05', '-'),
('8) 15.00 - 15.45', '-', 'УП по ПМ 05', '-', '-', '-', '-'),
('9) 15.55 - 16.40', '-', '-', '-', '-', '-', '-'),
('10) 16.50 - 17.35', '-', '-', '-', '-', '-', '-'),
('11) 17.45 - 18.30', '-', '-', '-', '-', '-', '-'),
('12) 18.40 - 19.25', '-', '-', '-', '-', '-', '-');
